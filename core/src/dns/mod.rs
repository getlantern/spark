...
//! answers each A/AAAA query with a **fake IP** from a dedicated range (`28.0.0.0/15` + an IPv6
//! `3000:2018::` slice — see [`fakeip::V4_BASE`] for why these and not 198.18/15 + a ULA), records
//! `fakeip→domain`, and recovers the domain when the app then connects to that fake IP
